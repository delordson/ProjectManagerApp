        ...
        BrowseMyProjectAssignments: $defineScreen(BrowseMyProjectAssignments, [
            {
                ...
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.MyProjectAssignments().expand("Client");
                }
            }
        ], [
        ]),
        ...
        BrowseMyTasks: $defineScreen(BrowseMyTasks, [
            {
                ...
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.MyTasks().expand("ProjectTask").expand("ProjectTask.Project");
                }
            }
        ], [
        ]),
        ...
        BrowseProjects: $defineScreen(BrowseProjects, [
            {
                name: "Projects", kind: "collection", elementType: lightSwitchApplication.Project,
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.Projects.expand("Client");
                }
            }
        ], [
        ]),
